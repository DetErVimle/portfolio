<template>
  <v-container>
    <v-toolbar flat class="mainHeader">
      <v-toolbar-title>PETER WINSTON</v-toolbar-title>
      <v-spacer></v-spacer>
      <v-toolbar-items class="hidden-xs-only">
        ...
        <v-btn v-for="icon in icons" :key="icon"  href="pw_cv.pdf" download >CV<v-icon style="margin-left:5px" size="16px">{{ icon }}</v-icon></v-btn>
